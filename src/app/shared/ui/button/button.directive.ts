...
// Aligned with official shadcn preset (.vendor/aim/components/ui/button.tsx)
...
/**
 * Directive that applies button styles to any element.
 * Use on <button> or <a> elements.
 *
 * @example
 * ```html
 * <button argusButton variant="outline" size="sm">Click me</button>
 * <a argusButton variant="link" href="/path">Link as button</a>
 * ```
 */
@Directive({
